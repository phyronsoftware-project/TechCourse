...
Route::get('/technology/category/{categorySlug}', [HomeController::class, 'technologyCategoryShow'])->name('technology.category.show');
Route::get('/technology/category/{categorySlug}/download', [HomeController::class, 'technologyCategoryDownload'])->name('technology.category.download');
