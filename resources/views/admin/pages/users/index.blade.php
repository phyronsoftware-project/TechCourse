                            ...
                            <td>
                                <details class="admin-action-list">
                                    ...
                                    <div class="admin-action-menu">
                                        ...
                                        {{-- Open manual course access with this user already selected. --}}
                                        <a href="{{ route('admin.enrollments.create', ['user_id' => $user->id]) }}" class="admin-action-link" title="Grant course access">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
