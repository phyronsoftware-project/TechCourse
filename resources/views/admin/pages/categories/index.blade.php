...
@section('content')
            ...
            <div class="admin-filter-grid">
                <div class="admin-field admin-filter-field-wide">
                    ...
                    <div class="admin-input-group">
                        <input id="search" type="text" name="search" value="{{ request('search') }}" placeholder="Category name or slug..." class="admin-input">
                ...
                <div class="admin-filter-actions">
                    ...
                    <a href="{{ route('admin.categories.index') }}" class="admin-btn admin-btn-secondary">Reset</a>
                </div>
            </div>
        </form>
    </section>
    ...
    <section class="admin-index-panel admin-index-panel-table">
        <div class="admin-page-header">
            <div>
                <h3 class="admin-page-title">Categories</h3>
                <p class="admin-page-copy">Organize course categories and display order.</p>
            </div>
            <a href="{{ route('admin.categories.create') }}" class="admin-btn admin-btn-primary">Create Category</a>
        </div>
        ...
        <div class="admin-table-wrap">
            <table class="admin-table">
                ...
                <tbody>
                            ...
                            <td>
                                <details class="admin-action-list">
                                    ...
                                    <div class="admin-action-menu">
                                        <a href="{{ route('admin.courses.index', ['search' => $category->name]) }}" class="admin-action-link" title="View courses">
                                        ...
                                        <a href="{{ route('admin.categories.edit', $category) }}" class="admin-action-link" title="Edit category">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                                <path d="M12 20h9" />
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="admin-empty">No category rows loaded yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
