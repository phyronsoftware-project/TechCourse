...
@section('content')
    <section class="admin-form-card p-6">
        ...
        <form action="{{ route('admin.courses.lessons.update', [$course, $lesson]) }}" method="POST" enctype="multipart/form-data" class="admin-form-grid mt-6" data-lesson-video-form>
            @csrf
            @method('PUT')
            ...
            <div class="admin-field" data-video-url-field>
                ...
                <div class="admin-input-group">
                    <input type="text" name="video_url" value="{{ old('video_url', $lesson->video_url) }}" class="admin-input" data-video-url-input>
            ...
            <div class="admin-field" data-video-file-field>
                ...
                @if ($lesson->video_file)
                    <p class="admin-section-copy mt-2 text-xs text-slate-500">
                        Current file: {{ basename((string) $lesson->video_file) }}
                    </p>
                @endif
            </div>
