        ...
        [
            ...
            'links' => [
                ...
                [
                    'label' => 'System',
                    'children' => [
                        ['label' => 'Reports', 'route' => route('admin.reports.index'), 'active' => request()->routeIs('admin.reports.*')],
                ...
                [
                    ...
                    'children' => [
                        ['label' => 'Banners', 'route' => route('admin.banners.index'), 'active' => request()->routeIs('admin.banners.*')],
                        ['label' => '', 'route' => route('admin.settings.index'), 'active' => request()->routeIs('admin.settings.*')],
                    ],
                ],
            ],
        ],
